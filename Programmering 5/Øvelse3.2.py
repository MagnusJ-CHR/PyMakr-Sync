    ...
    while True:
        if gps.receive_nmea_data():
            if gps.get_speed() != -999 and gps.get_latitude() != -999.0 and gps.get_longitude() != -999.0 and gps.get_validity() == "A":
                ...
                print("Mangler opkobling mod satellit. Kom nærmere et vindue") # Her har vi hvor den fanger en GPS som mangler koordinater.
                bounce(255,0,0)
        else:
            return False
while True:
    try:
        ...
        if gps_data:
            ...
            sleep(4)
            mqtt.web_print(gps.get_speed(), 'oqoqo/feeds/spfeed/csv')
            bounce(0,255,0)
        sleep(4)
